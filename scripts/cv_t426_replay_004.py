"""T426 coverage replay 004. Frozen catalogue, v3, and the dealer-mesh book. Does not overwrite replay 003."""
...
OUTPUT = Path("artifacts/runtime/cv019/T426_REPLAY_004.json")
...
def main() -> None:
    ...
    for lot in parsed.lots:
        ...
        group = str(evaluation.to_dict()["prebid_group"])
        payload = {
            "lot": lot.lot_number,
