...
class SourceStatus(str, enum.Enum):
    ...
    PRODUCTION_KEYSET_DISABLED_COMPLIANCE = "PRODUCTION_KEYSET_DISABLED_COMPLIANCE"
...
PRODUCTION_KEYSET_DISABLED_COMPLIANCE = SourceStatus.PRODUCTION_KEYSET_DISABLED_COMPLIANCE
