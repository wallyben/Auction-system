export type Lot = {
  ...
  quote?: {
    ...
    alt_label?: string;
    alt_vrt_max_bid_gbp?: string | null;
    alt_vrt_label?: string;
    ...
    selling_cost_eur?: string | null;
    auction_charges_eur?: string | null;
    buyer_premium_eur?: string | null;
    premium_vat_eur?: string | null;
    lot_vat_eur?: string | null;
    payment_fee_eur?: string | null;
    hammer_eur?: string | null;
    fees_and_tax_eur?: string | null;
    all_in_eur?: string | null;
